...
#[tauri::command]
fn save_config(app: AppHandle, api_key: String, model_id: String, base_url: String, compact_model_id: String, reasoning_enabled: bool, system_prompt: String) -> bool {
    let path = get_config_path(&app);
    let config = Config {
        api_key,
        model_id,
...
pub fn run() {
    tauri::Builder::default()
        .invoke_handler(tauri::generate_handler![load_config, save_config, load_memo_rules, save_memo_rules, load_memos, save_memos])
